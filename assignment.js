...
let primeaccount1=new PrimeAccount(2000,100);
let primeaccount2=new PrimeAccount(3000,500);
let customer1=new Customer(1,"Swathi",account1);
let customer2=new Customer(2,"jyothi",account2);
let customer3=new Customer(3,"Sandy",primeaccount1);
let customer4=new Customer(4,"Sakshi",primeaccount2);
